...
import cn.gx.modules.act.utils.ActivityUtil;
 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/act/trace")
public class ActTraceProcessController {
     ...
     * 读取流程资源
     */
    @RequestMapping(value = "data/auto/{executionId}")
...
//        InputStream imageStream =diagramGenerator.generateDiagram(bpmnModel, "png", activeActivityIds, highLightedFlows);
     ...
     * @return
     */
    @RequestMapping(value = "view/{executionId}")
