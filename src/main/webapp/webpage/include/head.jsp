<%@ page contentType="text/html;charset=UTF-8" %><meta http-equiv="Content-Type" content="text/html;charset=utf-8" /><meta name="author" content="http://www.bug.org/"/>
...
<!-- bug -->
<link href="${ctxStatic}/common/bug.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/common/bug.js" type="text/javascript"></script>
