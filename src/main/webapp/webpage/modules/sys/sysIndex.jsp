...
<head>
    ...
    <meta name="keywords" content="Bug快速开发平台">
    <meta name="description" content="Bug，采用spring mvc+mybatis+shiro+bootstrap，集成代码生成器的快速开发平台">
                        ...
                        <div class="dropdown profile-element">
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <li><a class="J_menuItem" href="${ctx }/iim/mailBox/list">信箱</a>
                                 ...
                                 <li class="divider"></li>
                                <li><a onclick="changeStyle('ace')" href="#">切换到ACE模式</a></li>
