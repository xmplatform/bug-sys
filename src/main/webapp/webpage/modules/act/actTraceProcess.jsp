...
<head>
    ...
    <script type="text/javascript" src="${ctxStatic }/modules/act/trace-process.js"></script>
</head>
...
<div>
    <img id="processDiagram" src="${ctx }/act/trace/read-resource?pdid=${historicProcessInstance.processDefinitionId}&resourceName=${processDefinition.diagramResourceName}" />
</div>

    <%-- 通过引擎自动生成图片并用红色边框标注
    <div>
        <img id="processDiagramAuto" src="${ctx }/act/trace/data/auto/${historicProcessInstance.processInstanceId}" />
    </div>--%>
    <hr>
    <fieldset>
