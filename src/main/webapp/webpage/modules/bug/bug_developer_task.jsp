	...
	<div class="row animated fadeInRight">
		...
		<div class="col-lg-8 col-md-8">
			...
			<form:form id="inputForm" modelAttribute="bug" action="${ctx}/bug/bug/saveAudit" method="post" class="form-horizontal">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label">解决:</label>
					<div class="col-sm-10">
						<form:textarea id="solution" htmlEscape="true" path="solution" rows="4" maxlength="200" class=" form-control input-xxlarge"/>
						<sys:ckeditor replace="solution" uploadPath="/bug/bug" />
					</div>
				</div>
